...
public class PartialIndex {
	...
	public static PartialIndex fromBson(BsonDocument doc) {
		return new PartialIndex(createRawIndexes(doc), createOptions(doc));
	}

	
	private PartialIndex(Set<Bson> indexes, IndexOptions options) {
		rawIndexes = indexes;
	...
	public boolean equals(Object obj) {
		...
		PartialIndex other = (PartialIndex) obj;
		if (rawIndexes == null) {
